...
<form action='<?=PATH?>/auth/storeClient' method="POST" autocomplete="off" class="row g-3 needs-validation" novalidate>
    <?php
    ...
    <div class="d-flex col-12 justify-content-center">
        <button class="btn btn-primary me-3" type="submit" name='crear'>Crear</button>
        <a class='btn btn-secondary' href="<?=PATH?>/auth/">Cancelar</a>
    </div>
</form>