...
<form action='<?=PATH?>/usuario/store' method="POST" autocomplete="off" class="row g-3 needs-validation" novalidate>
    <?php
    ...
    <div class="d-flex col-12 justify-content-center">
        <button class="btn btn-primary me-3" type="submit" name='crear'>Crear Usuario</button>
